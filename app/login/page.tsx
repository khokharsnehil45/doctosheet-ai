...
function LoginFormContent() {
  ...
  return (
    <div className="w-full max-w-md bg-white rounded-2xl border border-zinc-200 p-6 sm:p-8 shadow-xs space-y-6">
      {/* Header */}
      <div className="text-center space-y-1.5">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-zinc-100 text-zinc-700 text-[11px] font-medium border border-zinc-200 mb-1">
      ...
      {/* Mode Switcher Tabs */}
      <div className="flex rounded-lg bg-zinc-100 p-1 border border-zinc-200/80">
        <button
          type="button"
          onClick={() => {
            setMode('login');
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 text-xs rounded-lg border border-zinc-200 text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-zinc-900"
              />
            </div>
          </div>
        )}
        ...
        <button
          ...
          className="w-full py-2.5 px-4 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-white text-xs font-semibold transition-all shadow-xs flex items-center justify-center gap-2 cursor-pointer mt-2"
        >
      ...
      <div className="relative flex items-center justify-center">
        ...
        <span className="bg-white px-2 text-[11px] text-zinc-600 uppercase tracking-wider relative">
          or
        </span>
      </div>
      ...
      <button
        ...
        className="w-full py-2.5 px-4 rounded-lg bg-zinc-50 hover:bg-zinc-100 text-zinc-800 border border-zinc-200 text-xs font-semibold transition-colors flex items-center justify-center gap-2 cursor-pointer"
      >
      ...
      <div className="pt-2 text-center">
        <button
          ...
          className="text-[11px] text-zinc-600 hover:text-zinc-900 underline transition-colors cursor-pointer"
        >
...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col justify-between font-sans selection:bg-zinc-900 selection:text-white">
      {/* Minimal Top Header */}
      <header className="w-full border-b border-zinc-200 bg-white/80 backdrop-blur-xs">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-zinc-900 text-white flex items-center justify-center shadow-xs">
              <FileSpreadsheet className="w-4 h-4 text-zinc-100" />
            </div>
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6">
        <Suspense
          fallback={
            <div className="w-full max-w-md bg-white rounded-2xl border border-zinc-200 p-8 text-center text-xs text-zinc-500">
      ...
      {/* Minimal Footer */}
      <footer className="w-full border-t border-zinc-200 bg-white py-4 text-center text-xs text-zinc-600">
